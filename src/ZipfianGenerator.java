...
public class ZipfianGenerator extends IntegerGenerator
{
     ...
     */
    public int nextInt(int itemcount, ThreadLocalRandom tlr)
    {
        return (int)nextLong(itemcount, tlr);
    }
     ...
     * @return The next item in the sequence.
     */
    public long nextLong(long itemcount, ThreadLocalRandom tlr)
    {
    ...
    public int nextInt()
    {
        return (int)nextLong(items, ThreadLocalRandom.current());
    }
    ...
    {
        return nextLong(items, ThreadLocalRandom.current());
    }
